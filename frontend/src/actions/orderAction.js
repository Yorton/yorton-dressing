...
export const payOrderRequest = (order) => async (dispatch, getState) => {
...
export const payOrder = (order, paymentResult) => async (dispatch, getState) => {
    ...
    try{
        ...
        var newData = {};
        // if (linePayData.data && linePayData.data.paymentUrl){
        //     newData = {...data, paymentUrl: linePayData.data.paymentUrl};
        // }

        dispatch({type: ORDER_PAY_SUCCESS, payload: Object.entries(newData).length !== 0 ? newData : data});
